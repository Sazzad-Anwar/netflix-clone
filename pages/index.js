    ...
    <Layout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div className='flex justify-center items-center'>
              <div className='mb-3'>
                ...
                <p className='text-center w-full lg:text-left text-[1.125rem] lg:text-[1.6rem] text-white lg:w-[31.75rem]'>Watch on Smart TVs, Playstation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</p>
              </div>
            </div>
            <div className='relative'>
              <Image
                ...
                alt="tv-frame"
              />
              <div className='absolute top-[4rem] left-[3.8rem] sm:top-[5.1rem] sm:left-[4.5rem] lg:top-[4.4rem] lg:left-[3.8rem] xl:top-[5.25rem] xl:left-[4.5rem] '>
      ...
      <section className='bg-black'>
        <div className="container mx-auto py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 items-center">
            <div className='relative '>
              <div className="flex justify-start">
                <div>
                  ...
                  <div className="flex justify-center items-center">
                    <div className='absolute w-[20.62rem] bottom-[.87rem] lg:bottom-[1.87rem] flex justify-between items-center rounded-xl border-2 bg-black border-[#222222] px-3 py-2'>
                      <Image
                        src="/image-3.png"
                        layout='intrinsic'
                        height={80}
            ...
            <div>
              <h1 className='text-[1.625rem] text-center lg:text-left lg:text-[3.125rem] text-white font-bold lg:leading-[3rem] lg:px-10 mb-3'>Download your shows to watch offline.</h1>
              <h2 className='text-[1.125rem] text-center lg:text-left lg:text-[1.625rem] text-white font-medium lg:px-10 lg:leading-8'>Save your favorites easily and always have something to watch.</h2>
            </div>
          </div>
        </div>
        <div className='bg-[#222222] h-2'></div>
      ...
      <section className='bg-black'>
        <div className="container mx-auto py-14">
          <div className='text-center lg:text-left'>
            <h1 className='text-[1.625rem] lg:text-[3.125rem] text-white font-bold lg:leading-[3rem] lg:px-10 mb-3'>Watch everywhere.</h1>
            <h2 className='text-[1.125rem] mt-5 w-auto  lg:w-[36rem] lg:text-[1.625rem] text-white font-medium lg:px-10 lg:leading-8'>
      ...
      <section className='bg-black'>
        <div className="container mx-auto py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 items-center">
            ...
            <div>
              <h1 className='text-[1.625rem] text-center lg:text-left lg:text-[3.125rem] text-white font-bold lg:leading-[3rem] lg:px-10 mb-3'>Create profiles for kids.</h1>
              <h2 className='text-[1.125rem] text-center lg:text-left lg:text-[1.625rem] text-white font-medium lg:px-10 lg:leading-8'>Send kids on adventures with their favorite characters in a space made just for them—free with your membership.</h2>
            </div>
          </div>
        </div>
        <div className='bg-[#222222] h-2'></div>
      ...
      <section className='bg-black'>
        <div className="container mx-auto py-20">
          <h1 className='text-[1.625rem] text-center lg:text-[3.125rem] text-white font-bold lg:leading-[3rem] lg:px-10 mb-10'>Frequently Asked Questions</h1>
